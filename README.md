...
[![Version](https://img.shields.io/badge/version-5.6.0-blue.svg)](https://github.com)
...
本项目代码已脱敏，以下 **5 项配置** 在部署前**必须**按你的环境修改，否则功能无法正常工作。
...
# 上传到服务器
scp target/earthquake-warning-5.6.0.jar root@server:/opt/earthquake-warning/

# 启动
nohup java -jar /opt/earthquake-warning/earthquake-warning-5.6.0.jar > /dev/null 2>&1 &
```
